  ...
  webpackConfig.plugins.push(
    new OfflinePlugin({
      ...
      ServiceWorker: {
        ...
        publicPath: `${config('basePath')}/${config('serviceWorker.fileName')}`,
        ...
        // )}`,
        // navigateFallbackWhitelist: [/^\/counter/, /^\/about/],
      },
